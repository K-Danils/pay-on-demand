        ...
        <div className='container-responsive'>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <Paragraph style={{ fontSize: '18px', maxWidth: '600px', margin: '0 auto' }}>
              Access your earned salary on-demand. Manage your finances with flexibility and
              control.
            </Paragraph>
          </div>
          ...
          >
            ...
            >
              <Paragraph>
                Access your accumulated earnings instantly. Submit withdrawal requests and track
            ...
            >
              <Paragraph>
                Manage companies, users, and approve pay requests. Complete administrative control
                over the system.
              </Paragraph>
          ...
          <Card className='shadow-medium' style={{ textAlign: 'center' }}>
            ...
            <Paragraph>
              Sign in to access your dashboard and manage your on-demand salary requests.
            </Paragraph>
            <Space size='large'>
